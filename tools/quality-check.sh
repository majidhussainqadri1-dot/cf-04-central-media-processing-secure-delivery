...
php "$ROOT/tests/review-round-83-schema-shape.php"
php "$ROOT/tests/review-round-84-upload-terminal-order.php"
php "$ROOT/tests/review-round-85-validation-provenance.php"
php "$ROOT/tests/review-round-86-processing-review-pause.php"
php "$ROOT/tests/review-round-87-storage-boundaries.php"
php "$ROOT/tests/review-round-88-delivery-cdn-atomicity.php"
php "$ROOT/tests/review-round-89-lifecycle-reauthorization.php"
php "$ROOT/tests/review-round-90-operations-recovery.php"
php "$ROOT/tests/review-round-91-transfer-action-boundaries.php"
