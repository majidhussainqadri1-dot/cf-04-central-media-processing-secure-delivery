...
$expiryAuth=<<<'PATTERN'
self::authorizeCurrent($assetId,0,$reason,['scope'=>'derivatives','phase'=>'expire_derivatives'],'expire-derivatives')
PATTERN;
$holdAssert=<<<'PATTERN'
LegalHoldService::assertNoHold($assetId,$holdOperation)
PATTERN;
