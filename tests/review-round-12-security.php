...
$rest=file_get_contents($root.'/sabri-central-media/includes/class-scm-rest.php');$processStart=strpos($rest,'public static function processAsset');$processEnd=strpos($rest,'public static function issueGrant',$processStart);$process=substr($rest,$processStart,$processEnd-$processStart);$actorClaim=<<<'PATTERN'
'actor_id'=>$actor
PATTERN;
