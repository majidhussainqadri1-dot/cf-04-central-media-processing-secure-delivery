...
PATTERN;
$legacy=<<<'PATTERN'
$lock='scm_audit_chain_'.hash('sha256',Db::table('audit'));
PATTERN;
r80(str_contains($s,$bounded),'audit lock uses a bounded deterministic table-specific identifier');
r80(!str_contains($s,$legacy),'legacy 80-character audit lock construction is absent');
