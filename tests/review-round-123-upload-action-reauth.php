...
foreach(["'part'","'resume'","'complete'"] as $phase)r123(str_contains($s,"reauthorizeActiveUpload(".($phase=="'part'"?'$upload':'$u').",$actor,$phase)"),"upload $phase action is freshly authorized");
