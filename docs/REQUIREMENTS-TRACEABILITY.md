...
| CF04-A-010 | Prevent secrets and restricted data from entering the public repository | All contributors | SECURITY.md, .gitignore and policy CI | Implemented and automatically checked |
| CF04-A-011 | Preserve native domain ownership and prohibit direct writes | CF-04 + consumers | Ownership matrix and cross-repository source audit | Implemented in governance evidence |
