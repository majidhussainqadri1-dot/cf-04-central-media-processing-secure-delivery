...
| CF04-EV-002 | CF04-A-003 / CF04-A-011 | Cross-repository source architecture inventory | Files 10/11/12 candidate refs; Files 17/21/22 immutable canonical refs | `docs/audits/C4-A-CROSS-REPOSITORY-INVENTORY-AUDIT-2026-08-04.md` | Domain owners retain operational evidence | Current PR review | Source inventory complete; operational evidence pending |
| CF04-EV-003 | CF04-A-003 | Machine-readable source inventory | Schema 0.1.0 | `inventory/source-inventory-v0.1.json` | N/A | Current PR review | Corrected draft evidence |
| CF04-EV-004 | CF04-A-003 / CF04-A-005 | Staging evidence collection plan | Controlled staging only | `docs/audits/C4-A-STAGING-EVIDENCE-COLLECTION-PLAN.md` | Founder-designated staging operator | Current PR review | Plan drafted; execution pending |
...
| CF04-EV-007 | CF04-A-006 | Privacy-class mapping gate | C1–C5 definitions remain unapproved planning categories | `docs/audits/C4-A-PRIVACY-CLASS-MAPPING-GATE.md` | File 24 and affected domain owners | Current PR adversarial review | Blocked pending mapping approval |
